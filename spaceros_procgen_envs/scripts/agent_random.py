...
"""
Testing script for running tasks with random actions (useful during development)

Note: This script does not use the Space ROS interface

Examples:
    ros2 run spaceros_procgen_envs agent_random.py
    ros2 run spaceros_procgen_envs agent_random.py --task sample_collection --num_envs 4
"""
